...
const NAME_VERBS = new Set([
  ...
  'search', 'list', 'fetch', 'send', 'post', 'put', 'read', 'write',
  'check', 'validate', 'verify', 'parse', 'convert', 'generate',
  'run', 'execute', 'start', 'stop', 'open', 'close', 'connect',
  'enable', 'disable', 'upload', 'download', 'export', 'import',
