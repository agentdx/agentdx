...
export function registerLintCommand(program: Command): void {
  program
    ...
    .action(async (opts: { format: string; fixSuggestions?: boolean; quiet?: boolean; config?: string }) => {
      ...
      switch (format) {
        ...
        case 'sarif':
          ...
          break;
        default:
          console.log(formatText(result, config.server?.name, { fixSuggestions: opts.fixSuggestions }));
          break;
      }
